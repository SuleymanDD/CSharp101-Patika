...
class Ogrenci
{
	...
	public void OgrenciBilgileriniGetir()
	{
		...
		Console.WriteLine("Öğrenci adi:     "+this.Isim);
		Console.WriteLine("Öğrenci soyadi:  "+this.Soyisim);
		Console.WriteLine("Öğrenci no:      "+this.OgrenciNo);
		Console.WriteLine("Öğrenci sinifi:  "+this.Sinif);
	}
